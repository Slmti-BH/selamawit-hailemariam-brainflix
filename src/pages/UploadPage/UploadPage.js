    ...
    <main className="upload-page">
      ...
      <div className="upload-page__container">
        ...
        <form className="upload-page__form" action="">
          ...
          <input className="upload-page__form-title" type="text" name="title" placeholder="Add a title to your video" />
      ...
      <div className="upload-page__btn-container">
        <button className="upload-page__publish-btn" onClick={handlePublish}>PUBLISH</button>
        <button className="upload-page__cancel-btn"onClick={handleCancel}>CANCEL</button>
      </div>
    </main>
  );
}
